...
import com.isoft.qzm.feign.GatewayProxy;
import com.isoft.qzm.security.SecurityUtils;
...
//    @Autowired
    ...
    public ProductResource(ProductService productService, ProductQueryService productQueryService,GatewayProxy gatewayProxy) {
